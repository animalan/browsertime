...
import { isAndroidConfigured } from './index.js';
// const delay = ms => new Promise(res => setTimeout(res, ms));
/**
 * Manages the collection of Simpleperf profiles on Android.
 *
 * @class
 * @hideconstructor
 */

const log = getLogger('browsertime.simpleperf');

/**
 * Timeout a promise after ms. Use promise.race to compete
 * about the timeout and the promise.
 * @param {promise} promise - the promise to wait for
 * @param {int} ms - how long in ms to wait for the promise to finish
...
export class Simpleperf {
  ...
  async start(profilerOptions, recordOptions, dirName) {
